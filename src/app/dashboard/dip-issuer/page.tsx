  ...
  useEffect(() => {
    const fetchIssuerInfo = async () => {
      try {
        ...
        // ⚠️ CHỈ ISSUER mới được xem dashboard trường
        ...
        const res = await axiosInstance.get(`/dip-issuer/me/info`);
    ...
    <div className="min-h-screen flex flex-col text-white">
      ...
      <main className="flex-1 px-6 py-10 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Quản lý chuyên viên và văn bằng</p>
        </div>
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-purple-100">
                  Thêm một hoặc nhiều chuyên viên
                </p>
              </div>
            </button>
          </div>
